...
const AdminPage = () => {
  ...
  return (
    <div className="admin-dashboard">
      {/* Admin Header */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-4 md:p-6 mb-6">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold mb-2">Admin Dashboard</h1>
            <p className="text-blue-100 text-sm md:text-base">Manage NJDSC Compliance Portal operations and settings</p>
          </div>
          <div className="flex items-center space-x-3 flex-shrink-0">
            ...
            <button
              onClick={() => navigate('/')}
              className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-blue-800 flex items-center space-x-2"
            >
      ...
      <div className="border-b border-gray-200 mb-6">
        <nav className="flex overflow-x-auto md:space-x-8 md:justify-start">
          {navigationItems.map((item) => (
            <Link
              key={item.id}
              to={`/admin/${item.id}`}
              className={`py-4 px-3 md:px-1 border-b-2 font-medium text-sm flex items-center space-x-2 whitespace-nowrap flex-shrink-0 ${
                activeTab === item.id
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <div className="text-xl md:text-2xl font-bold text-gray-900">{reports.length}</div>
          ...
          <div className="text-center p-3 bg-blue-50 rounded-lg">
            ...
            <div className="text-xs md:text-sm text-gray-600">New Reports</div>
          </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredReports.map((report) => (
                  ...
                  >
                    ...
                    <td className="hidden md:table-cell px-6 py-4 whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
